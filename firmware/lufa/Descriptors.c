...
// power consumption = max 150mA for the keyboard and 50 for the Arduino
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"Sun Microsystems, Inc.");
